...
def Hyperlink(r):
    global Hyper_list
    Index.cell(row=r, column=1).hyperlink= ("Quantum-II-MIM-IA_Final.xlsx#{}!{}".format(Hyper_list[0],str(Index.cell(row=Hyper_list[1], column=Hyper_list[2])).replace('>','').split('.')[1]))
